...
<body class="w3-yellow w3-content" style="max-width:1600px">

<!-- Sidebar/menu -->
<nav class="w3-sidebar w3-bar-block w3-white w3-animate-left w3-text-grey w3-collapse w3-top w3-center" style="z-index:3;width:300px;font-weight:bold" id="mySidebar"><br>
<img src="https://scontent.xx.fbcdn.net/v/t1.15752-9/441101461_366230792571935_8093690890185688077_n.jpg?stp=dst-jpg_s403x403&_nc_cat=108&ccb=1-7&_nc_sid=5f2048&_nc_ohc=MmzvJztCqg8Q7kNvgFX0-iq&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=03_Q7cD1QGo75Dj-D7cigbH-WzXO4e5FFGXCRYIJeltuTDsw8IsAA&oe=666B1CB8" alt="Me" class="w3-image w3-padding-32" width="600" height="650">
  <h3 class="w3-padding-64 w3-center"><b>RENZO<br>LOUIS</b></h3>
...
<header class="w3-container w3-top w3-hide-large w3-pink w3-xlarge w3-padding-16">
  <span class="w3-left w3-padding">RENZO LOUIS</span>
  <a href="javascript:void(0)" class="w3-right w3-button w3-blue" onclick="w3_open()">☰</a>
</header>
...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-container w3-dark-grey w3-center w3-text-light-grey w3-padding-32" id="about">
    <h4><b>IT PROFESSIONAL</b></h4>
    <img src="https://scontent.xx.fbcdn.net/v/t1.15752-9/441135145_962535465321283_6819681028210842001_n.jpg?stp=dst-jpg_p403x403&_nc_cat=109&ccb=1-7&_nc_sid=5f2048&_nc_ohc=roVeAEGxVmAQ7kNvgG5jlCO&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=03_Q7cD1QHdA9R4cu0NkCj_0gKm9QzGkjAuka8bx-MGWm7PzR_kSA&oe=666AFD90" alt="Me" class="w3-image w3-padding-32" width="600" height="650">
    <div class="w3-content w3-justify" style="max-width:600px">
      <h4>RENZO LOUIS DULAY</h4>
